...
<div class="m-3">
  ...
  <div class="col-12">
    <ul class="progressbar">
      <li class="active">เพิ่มรายการสินทรัพย์</li>
      <?php if ($sumitem >= 1) { ?>
        <li class="active">มีรายละเอียดภายในอุปกรณ์</li>
      <?php } else { ?>
        <li class="">รอการบันทึกรายละเอียดภายในอุปกรณ์</li>
      <?php } ?>
      <?php if ($card_detail->card_status != NULL) { ?>
        <li class="active">ยืนยันการบันทึกข้อมูล สถานะปัจจุบัน : <?php echo @cardstatus($card_detail->card_status); ?></li>
      <?php } else { ?>
        <li class="">รอการยืนยันการบันทึกข้อมูลอีกครั้ง</li>
      <?php } ?>
    </ul>
  </div>
...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <div class="form-group row">
      <div class="col-md-3 col-sm-3"><strong>ชื่อเครื่อง :</strong></div>
      <div class="col-md-3 col-sm-3"><?php echo $card_detail->card_note; ?></div>
      <div class="col-md-3 col-sm-3"><strong>ST/SN :</strong></div>
      <div class="col-md-3 col-sm-3"><?php echo @$card_detail->card_serial; ?></div>
  ...
  <div class="card-footer text-center">
    ...
    <button class="ladda-button btn btn-warning btn-square btn-ladda bg-success" data-style="expand-left" type="button" data-toggle="modal" data-target="#save_card">
      <span class="fas fa-save"> บันทึกข้อมูลเข้าสู่ระบบ</span>
      <span class="ladda-spinner"></span>
    </button>
  </div>
</div>