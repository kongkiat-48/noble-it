            ...
            <div class="row mt-3 mb-0">
              ...
              <div class="col-md-3 col-sm-6">
                <div class="media widget-media p-4 rounded bg-white border">
                  ...
                  <div class="media-body align-self-center">
                    <h4 class="text-success mb-2"><?php @$getall = $getdata->my_sql_show_rows($connect, "card_info", "card_status = 'd2b25dcd6a5b3621742af4b6c2f90968' <> 'hidden' AND card_delete ='1'");
                                                  echo @number_format($getall); ?></h4>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="media widget-media p-4 rounded bg-white border">
                  ...
                  <div class="media-body align-self-center">
                    <h4 class="text-warning mb-2"><?php @$getall = $getdata->my_sql_show_rows($connect, "card_info", "card_status IN ('4386e24965ef6e3b5751cd8f4e7b27db','ea7b77e8f805ee1ba69d5fd8515dea1b','968d42cbf280bc3c26103d31955bae59','5b93205f13e238f5a1904e095016e81f','876e933c13f11540337913cd5eba269e','64739b78967a299e92a4b49b8ae93015','02b5a3574052961b5336356a9a634d05') AND card_delete ='1'");
                                                  echo @number_format($getall); ?></h4>
