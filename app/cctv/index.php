                    ...
                    <div class="basic-data-table">
                        <table id="data-home-it" class="table hover nowrap text-center" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $i = 0;
                                $get_total = $getdata->my_sql_select($connect, NULL, "problem_list", "user_key = '" . $_SESSION['ukey'] . "'AND approve_department = 'IT' AND se_id = '8' AND se_li_id = '154' ORDER BY ticket DESC");
                                while ($show_total = mysqli_fetch_object($get_total)) {
                                    $i++;
                                ?>
                                    <tr>
