  ...
  <div class="card-body m-3">
    <div class="responsive-data-table-cus">
      <table id="responsive-data-table-cus" class="table dt-responsive nowrap hover text-center" width="100%">
        ...
        <tbody>
          <?php
          $getcard_status = $getdata->my_sql_select($connect, NULL, "problem_comment,card_type", "problem_comment.ticket='" . $card_detail->ticket . "' AND problem_comment.card_status=card_type.ctype_key ORDER BY problem_comment.date DESC");
