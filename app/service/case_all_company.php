         ...
         <div class="card-body">
            <div class="responsive-data-table">
               <table id="responsive-data-table-it-cancel" class="table dt-responsive nowrap" style="width:100%" data-order='[ 3, "DESC" ]'>
                  ...
                  <tbody>
                     <?php
                     $get_total = $getdata->my_sql_select($connect, NULL, "problem_list", "company = '" . $card_detail->company . "' AND card_status = '57995055c28df9e82476a54f852bd214' ORDER BY ticket DESC"); //AND date LIKE '%" . date("Y") . "%' 
                     while ($show_total = mysqli_fetch_object($get_total)) {
                     ?>
                        <tr>
                           <td>
