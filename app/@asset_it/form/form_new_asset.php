...
if (isset($_POST['save_card'])) {
    if ($getcontrol < 50) {
        if (htmlspecialchars($_POST['card_customer_name']) != NULL && htmlspecialchars($_POST['asset_code']) != NULL) {
          ...
          card_date_ex = '" . htmlspecialchars($_POST['card_date_ex']) . "',
...
<form method="post" enctype="multipart/form-data" class="was-validated" id="waitsave">
    <div class="form-group row">
        ...
        <div class="col-md-3 col-sm-6">
            ...
            <input type="text" name="asset_code" id="asset_code" class="form-control input-sm" placeholder="Code Asset IT" autofocus required>
        ...
        <div class="col-md-3 col-sm-12">
            ...
            <select name="company" id="company" class="form-control input-sm select2bs4" style="width: 100%;" required>
        ...
        <div class="col-md-3 col-sm-12">
            ...
            <input type="text" name="card_possess" id="card_possess" class="form-control input-sm" placeholder="Asset Possess" required>
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        <div class="col-md-6 col-sm-12">
            ...
            <select name="card_customer_name" id="card_customer_name" class="form-control input-sm select2bs4" style="width: 100%;" required>
                <option value="" selected>--- เลือกข้อมูล ---</option>
                <?php
        ...
        <div class="col-md-6 col-sm-12">
            ...
            <input type="date" name="card_date_buy" id="card_date_buy" class="form-control input-sm input-sm" required>
            <div class="invalid-feedback">
                ระบุ วันที่.
            </div>
        </div>
    ...
    <div class="form-group row">
        <div class="col-md-4 col-sm-12">
            ...
            <select name="card_device_id" id="card_device_id" class="form-control input-sm select2bs4" style="width: 100%;" required>
        ...
        <div class="col-md-2 col-sm-6">
            ...
            <input type="number" name="card_sum" id="card_sum" class="form-control input-sm input-sm" autocomplete="off" placeholder="ชิ้น / ชุด" required="" min="1" max="99">
            <div class="invalid-feedback">
                ระบุ จำนวน.
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
            ...
            <input type="text" name="card_ex" id="card_ex" class="form-control input-sm input-sm" placeholder="1 ปี / 1 เดือน" autocomplete="off" required>
            <div class="invalid-feedback">
                ระบุ ระยะเวลาการรับประกัน.
            </div>
        </div>
        <div class="col-md-3 col-sm-6">
            <label for="card_date_ex">วันที่หมดประกัน</label>
            <input type="date" name="card_date_ex" id="card_date_ex" class="form-control input-sm input-sm" required>
            <div class="invalid-feedback">
                ระบุ วันที่หมดประกัน.
            </div>
        </div>
    ...
    <div class="form-group row">
        <div class="col-md-4 col-sm-12">
            ...
            <input type="text" name="card_brand" id="card_brand" class="form-control input-sm input-sm" autofocus="off" placeholder="Brand name" required>
            <div class="invalid-feedback">
                ระบุ ยี่ห้อ.
            </div>
        </div>
        <div class="col-md-4 col-sm-12">
            ...
            <input type="text" name="card_model" id="card_model" class="form-control input-sm input-sm" autofocus="off" placeholder="Model name" required>
            <div class="invalid-feedback">
                ระบุ รุ่น.
            </div>
        </div>
        <div class="col-md-4 col-sm-12">
            ...
            <input type="text" name="card_serial" id="card_serial" class="form-control input-sm input-sm" autocomplete="off" placeholder="S/T | S/N" required>
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        <div class="col-md-4 col-sm-12">
            ...
            <input type="tel" name="card_customer_phone" id="card_customer_phone" class="form-control input-sm input-sm" required>
            <div class="invalid-feedback">
                ระบุ เบอร์โทรติดต่อ Supplier.
            </div>
        </div>
        <div class="col-md-4 col-sm-12"> <label for="card_customer_email">E-mail Supplier</label>
            <input type="email" name="card_customer_email" id="card_customer_email" class="form-control input-sm input-sm" required>
            <div class="invalid-feedback">
        ...
        <div class="col-md-4 col-sm-12">
            ...
            <input type="text" name="card_note" id="card_note" class="form-control input-sm input-sm" required>
            <div class="invalid-feedback">
    ...
    <div class="form-group row">
        <div class="col-md-7">
            ...
            <input type="text" name="name_license" id="os" class="form-control input-sm input-sm" disabled="disabled" placeholder="Windows" required>
            <div class="invalid-feedback">
        ...
        <div class="col-md-5">
            ...
            <input type="text" name="key_license" id="key" class="form-control input-sm input-sm" disabled="disabled" placeholder="xxxxx-xxxxx-xxxxx-xxxxx-xxxxx" required>
            <div class="invalid-feedback">
                Key license.
            </div>
        </div>
    ...
    <div class="form-group row">
        <div class="col-md-7">
            ...
            <input type="text" name="p_license_name" id="program" class="form-control input-sm input-sm" disabled="disabled" placeholder="Program" required>
            <div class="invalid-feedback">
        ...
        <div class="col-md-5">
            ...
            <input type="text" name="p_license_key" id="programkey" class="form-control input-sm input-sm" disabled="disabled" placeholder="xxxxx-xxxxx-xxxxx-xxxxx-xxxxx" required>
            <div class="invalid-feedback">
                Key license.
            </div>
        </div>
    ...
    <div class="form-group row">
        <div class="col-md-6 col-sm-12">
            ...
            <input type="file" name="pic" id="pic" class="form-control input-sm input-sm" required>
            <div class="invalid-feedback">
                ระบุ รูปภาพอุปกรณ์.
            </div>
        </div>
        <div class="col-md-6 col-sm-12">
            ...
            <input type="text" name="card_price" id="currency-field" class="form-control input-sm input-sm" required data-type="currency" placeholder="0.00">
            <div class="invalid-feedback">
                ระบุ ราคาอุปกรณ์.
            </div>
        </div>
