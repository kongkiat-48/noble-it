...
<div class="modal-body">
   ...
   <div class="form-group row">
      <div class="col-md-6">
         <label for="edit_card_email">E-mail</label>
         <input type="text" name="edit_card_email" id="edit_card_email" class="form-control input-sm" placeholder="อีเมล" value="<?php echo @$getuse_detail->card_customer_email; ?>">
      </div>
      <div class="col-md-6">
